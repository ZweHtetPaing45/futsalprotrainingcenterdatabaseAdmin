...
class localBookingService {
    ...
    async AdminBooking(venue_id,court_id,payment_method,reciept_no,date,court_time_slot_ids,department,items,file){

        const result = await repo.AdminBooking(venue_id,court_id,payment_method,reciept_no,date,court_time_slot_ids,department,items,file);
